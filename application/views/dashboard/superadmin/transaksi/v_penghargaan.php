                ...
                <div class="modal-content"> 
                    ...
                    <div class="modal-body"> 
                        <div class="row"> 
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group"> 
                                    <label for="field-2" class="control-label">Bonus</label> 
                                    <input class="form-control autonumber" id="field-2" data-a-sign="" placeholder="Bonus"> 
                                </div> 
                            </div> 
                        </div>  
                        <div class="row"> 
                    ...
                    <div class="modal-body"> 
                        <div class="editmodal hidden">
                            <div class="row"> 
                                ...
                                <div class="col-md-6"> 
                                    <div class="form-group"> 
                                        <label for="field-12" class="control-label">Bonus</label> 
                                        <input class="form-control autonumber" id="field-12" data-a-sign="" placeholder="Bonus"> 
                                    </div> 
                                </div> 
                            </div>  
                            <div class="row"> 
                        ...
                        <div class="deletemodal hidden">
                            ...
                            <div class="alert alert-warning"><p>Apakah Anda yakin mau memhapus penghargaan ini?</p></div>
                        </div>
                    </div> 
                    <div class="modal-footer"> 
                        <div class="editmodal">
            ...
            <div class="modal-dialog"> 
                <div class="modal-content"> 
                    <div class="custom-modal-title"> 
                        ...
                        <h4 class="custom-modal-title">Action Penghargaan</h4> 
                    </div> 
                    <div class="modal-body"> 
                        <div class="">
                            <div class="row"> 
        ...
        $('.select2').select2();
              ...
              $('.autonumber').autoNumeric('init');  
                ...
                $('#btn_simpan').on('click',function(){
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('index.php/transaksi_penghargaan/simpan_penghargaan')?>",
                        dataType : "JSON",
                ...
                $('#datatable-buttons').on('click','.lihat-row',function(){
                    ...
                    $.ajax({
                        type : "GET",
                        url  : "<?php echo base_url('index.php/transaksi_penghargaan/get_penghargaan')?>",
                        dataType : "JSON",
                        data : {id:id},
                        success: function(data){
                            bukatutup(true);
                ...
                $('#btn_edit').on('click',function(){
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('index.php/transaksi_penghargaan/update_penghargaan')?>",
                        dataType : "JSON",
                ...
                $('#btn_hapus').on('click',function(){
                    ...
                    $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('index.php/transaksi_penghargaan/hapus_penghargaan')?>",
                    dataType : "JSON",
                            data : {kode: kode},
                            success: function(data){
                                $('#customedit-modal').modal('hide');
