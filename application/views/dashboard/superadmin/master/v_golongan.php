                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="m-t-0 header-title"><b>Master Golongan</b></h4>
                            </div>
                            <div class="col-md-6">
                            ...
                            <a href="#custom-modal" class="btn btn-default btn-md waves-effect waves-light m-b-30 pull-right" data-animation="slit" data-plugin="custommodal" data-overlayspeed="200" data-overlaycolor="#36404a"><i class="md md-add"></i> Tambah Golongan</a>
                            </div>
                            </div>
            ...
            <div class="modal-dialog"> 
                <div class="modal-content"> 
                    <div class="custom-modal-title"> 
                        ...
                        <h4 class="custom-modal-title">Master Golongan</h4> 
                    </div> 
        ...
        <div id="customedit-modal" class="modal-demo">
            <div class="modal-dialog"> 
                <div class="modal-content"> 
                    <div class="custom-modal-title"> 
                        <button type="button" class="close" onclick="Custombox.close();"><span>&times;</span><span class="sr-only">Close</span></button> 
                        <h4 class="custom-modal-title">Edit Golongan</h4> 
                    </div> 
                    <div class="modal-body"> 
                        <div class="editmodal">
                            <div class="row"> 
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                    var table = $("#datatable-buttons").DataTable({
                      processing: true,
                      serverSide: true,
                              ajax: {"url": "<?php echo base_url().'index.php/master/get_golongan_json'?>", "type": "POST"},
                                    columns: [
                                        {"data": "view"},
                                        {"data": "golongan"},
                                        {"data": "eselon"},
                                        ...
                                        {"data": "keterangan"},
                                        {"data": "cuti", render: $.fn.dataTable.render.number(',', '.', ''), className: "text-right"},
                                        {"data": "gaji", render: $.fn.dataTable.render.number(',', '.', ''), className: "text-right"},
                                        {"data": "bonus", render: $.fn.dataTable.render.number(',', '.', ''), className: "text-right"}
                                  ],
                                order: [[2, 'asc']],
                        dom: "Bfrtip",
                        buttons: [{
