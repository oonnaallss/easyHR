        ...
        <script type="text/javascript">
              ...
              $('.autonumber').autoNumeric('init'); 
                ...
                var coba = [];
                 ...
                 function getKalender(){
                      coba = [];
                    $('#calendar').fullCalendar('removeEventSource', coba);
                     $.getJSON( "<?php echo base_url().'index.php/dashboard_superadmin/getKalender'?>", function( data ) {
                      $.each( data, function( key, val ) {
                        coba.push({title:val.nama,className:val.class, start:new Date(val.startdate),end:new Date(val.enddate)});
                      });
                    });
                    $('#calendar').fullCalendar('addEventSource', coba);
                    $('#calendar').fullCalendar( 'rerenderEvents' );
                 }
                 function getView(data,tanggal){
                     $.getJSON( "<?php echo base_url().'index.php/dashboard_superadmin/getData'?>", {title:data, tanggal:tanggal}, function( respon ) {
                        $('.infohtml').empty();
            ...
            jQuery(document).ready(function($) {
                ...
                $('#btn_masuk').click(function(e){
                    ...
                    $.post("<?php echo base_url().'index.php/dashboard_superadmin/masuk'?>",
                      function(response){
                      }, "json")
                    .done(function( data ) {
                ...
                $('#btn_keluar').click(function(e){
                    ...
                    var l = Ladda.create(this);
                    l.start();
                    $.post("<?php echo base_url().'index.php/dashboard_superadmin/keluar'?>",
                      function(response){
                      }, "json")
                    .done(function( data ) {
                        location.reload();
