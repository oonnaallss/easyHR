            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo base_url(); ?>dashboard_administrator" class="logo"><i class="icon-magnet icon-c-logo"></i><span><?php echo $company ?></span></a>
                        <!-- Image Logo here -->
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown top-menu-item-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>
                                        <li><a href="<?php echo base_url(); ?>dashboard_administrator/logout"><i class="ti-power-off m-r-10 text-danger"></i> Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="ti-agenda"></i><span class="label label-primary pull-right">2</span><span> Master </span> </a>
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo base_url(); ?>master"><i class="fa fa-venus-mars"></i> Golongan & Gaji Pokok</a></li>
                                    <li><a href="<?php echo base_url(); ?>master_jam_kerja"><i class="ti-target"></i> Jam Kerja</a></li>
                                    <li><a href="<?php echo base_url(); ?>master_perusahaan"><i class="ti-target"></i> Perusahaan</a></li>
                                    <!-- <li><a href="<?php echo base_url(); ?>master_jenis_pelatihan"><i class="ti-target"></i> Jenis Pelatihan</a></li> -->
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>transaksi_hukuman"><i class="fa fa-gavel"></i> Pinjaman</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <!-- <li><a href="<?php echo base_url(); ?>laporan_cuti"><i class="icon-eye-open"></i> Cuti</a></li>
                                    <li><a href="<?php echo base_url(); ?>laporan_kehadiran"><i class="icon-tag"></i> Kehadiran</a></li> -->
                                   <!--  <li><a href="<?php echo base_url(); ?>laporan_pelatihan"><i class="icon-ok-sign"></i> Pelatihan</a></li> -->
